...
# define ITK_COMPILER_VERSION_MAJOR (__clang_major__)
# define ITK_COMPILER_VERSION_MINOR (__clang_minor__)
# define ITK_COMPILER_VERSION_PATCH (__clang_patchlevel__)
# if defined(_MSC_VER)
   /* _MSC_VER = VVRR */
#  define ITK_SIMULATE_VERSION_MAJOR (_MSC_VER / 100)
#  define ITK_SIMULATE_VERSION_MINOR (_MSC_VER % 100)
# endif
# define ITK_COMPILER_VERSION_TWEAK (__apple_build_version__)
